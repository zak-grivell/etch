...
//     Definition, Ident, Lambda, MatchDefinition, NumberLiteral, Object, ObjectAccess, PartialType,
...
//         self.transform(mtch.on)
//             .zip(
//                 mtch.arms
//                     .into_iter()
//                     .map(|(cond, body)| {
//                         self.scopes.push(BTreeMap::new());
//                         let r = self.transform(cond).zip(self.transform(body));
//                         self.scopes.pop();
...
//         Results::ok((node, SymbolMetadata { span: meta.span }))
//     }
...
//         let symbol = self.next_symbol(match_definition.ident.clone());

//         self.scopes
//             .last_mut()
//             .unwrap()
//             .insert(match_definition.ident.clone(), symbol.clone());
